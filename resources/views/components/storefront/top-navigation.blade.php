    ...
    <div class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
        ...
        <div class="fixed inset-0 z-40 flex">
            ...
            <div class="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <div class="space-y-6 border-t border-gray-200 px-4 py-6">
                    {{-- TODO: FIX RENDERING ON THIS --}}
                    @auth
                        <div class="flow-root">
                            <a href="{{ url('/dashboard') }}" class="-m-2 block p-2 font-medium text-gray-900">Account</a>
                        </div>
                    @else
                        <div class="flow-root">
                        ...
                        <div class="flex h-full space-x-8">
                            <div class="flex" x-data="{ open: false }">
                                <div class="relative flex">
                                    ...
                                    <button @click="open = ! open" type="button" class="border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out" aria-expanded="false">Women</button>
                                </div>
                            ...
                            <div class="flex" x-data="{ open: false }">
                                <div class="relative flex">
                                    <!-- Item active: "border-indigo-600 text-indigo-600", Item inactive: "border-transparent text-gray-700 hover:text-gray-800" -->
                                    <button @click="open = ! open" type="button" class="border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out" aria-expanded="false">Men</button>
                                </div>
                    ...
                    <div class="ml-auto flex items-center">
                        ...
                        <div class="hidden lg:ml-8 lg:flex">
                            <a href="#" class="flex items-center text-gray-700 hover:text-gray-800">
                                <img src="https://tailwindui.com/img/flags/flag-united-kingdom.svg" alt="" class="block h-auto w-5 flex-shrink-0">
